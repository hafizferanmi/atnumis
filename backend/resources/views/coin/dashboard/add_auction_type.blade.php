...
<div class="right_col" role="main">
    <form method="post" enctype="multipart/form-data" action="{{ route('dashboard.coin.add.auction_type.post') }}" id="theForm" class="form-horizontal form-label-left" data-parsley-validate="">
            ...
            <div class="row">
                ...
                <div class="col-sm-7 col-xs-12">
                    ...
                    <div class="x_panel" id="pFinalized">
                        <div class="x_title">
                            <h2> Add new auction <small><span id="sPercentage"></span></small></h2>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input name="auction_type" type="text" value="" id="" class="form-control" placeholder="Auction Name" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input name="auction_starts" type="date" value="" id="" class="form-control" placeholder="Auction Starts" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input name="auction_ends" type="date" value="" id="" class="form-control" placeholder="Auction Ends" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <input type="submit" name="" value="Add auction" id="btnSetInventory" class="btn btn-success" />
...
@section('title')
    Atnumis &middot Add new auction.
@stop