            ...
            <div class="row">
                <div class="col-sm-7 col-xs-12">
                    ...
                    <div class="x_panel" id="pFinalized">
                        <div class="x_title">
                            <h2> Add page content <small><span id="sPercentage"></span></small></h2>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="page_title" type="text" value="" id="" class="form-control" placeholder="Page title" />
                                    </div>
                                </div>
                                <div class="form-group">
...
@stop
@section('title')
Atnumis &middot Add page content.
@stop
