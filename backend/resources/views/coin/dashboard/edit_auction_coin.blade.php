...
<div class="right_col" role="main">
    <form method="post" action="/auction/coin/update" id="theForm" class="form-horizontal form-label-left" data-parsley-validate="">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content" id="x_c_inventory">
                            {{-- <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Coin option:</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <select name="coin_type" onchange="" id="" class="select2_single form-control">
                                        <option value='auction' {{ $coin->coin_type == 'bid' ? 'selected' : '' }}>Auction</option>
                                        <option value="sell" {{ $coin->coin_type == 'sell' ? 'selected' : '' }}>Selling</option>
                                        <option value="both" {{ $coin->coin_type == 'both' ? 'selected' : '' }}>Both</option>
                                    </select>
                                </div>
                            </div> --}}
                            <div class="form-group">
                        ...
                        <div class="x_content" id="x_c_finalized">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="starting_price" type="text" value="{{ $coin->starting_price }}" id="" class="form-control" placeholder="Starting Price" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Bid increment:</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="bid_increment" type="text" value="{{ $coin->bid_increment }}" id="" class="form-control" placeholder="Bid increment" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Auction starts:</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="auction_starts" type="datetime" value="{{ $coin->auction_starts }}" id="" class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Auction ends:</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="auction_ends" type="datetime" value="{{ $coin->auction_ends }}" id="" class="form-control" />
                                    </div>
                                </div>
                    ...
                    <div class="x_panel" id="pNavigation">
                        <div class="x_title">
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="submit" name="btnSetInventory" value='Modify Coin' id="btnSetInventory" class="btn btn-success" />
