        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_planel">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Highest Bidders  <small></small></h2>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($highest_bidders as $highest_bidder)
                                            <tr>
                                               ...
                                               <td> {{ $highest_bidder['username'] }} </td>
                                               <td> {{ $highest_bidder['no_of_coins']  }} </td>
                                               <td><a class="btn btn-primary btn-xs" href="/auction/{{ $auctionId }}/{{ $auctionSlug }}/order/{{ $highest_bidder['username'] }}"> View </a></td>
