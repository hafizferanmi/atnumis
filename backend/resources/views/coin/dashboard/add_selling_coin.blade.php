...
<div class="right_col" role="main">
    <form method="post" action="{{ route('dashboard.coin.add.selling.post') }}" id="theForm" class="form-horizontal form-label-left" enctype="multipart/form-data" >
        ...
        <div id="ctl00_upDefault">
            ...
            <div class="row">
                <div class="col-sm-7 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Add selling coin info <small></small> </h2>
                        ...
                        <div class="x_content" id="x_c_inventory">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input name="file" type="file" value="" id="" class="" />
                                </div>
                            </div>
                ...
                <div class="col-sm-5 col-xs-12">
                    <!-- Right column panels -->
                     ...
                     <div class="x_panel" id="">
                        <div class="x_title">
                            <h2> Buying Details <small><span id="sPercentage"></span></small></h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                </li>
                            </ul>
                        ...
                        <div class="x_content" id="x_c_finalized">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="price" type="text" value="" id="" class="form-control" placeholder="Price" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Quantity:</label>
                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                        <input name="quantity" type="text" value="" id="" class="form-control" placeholder="Quantity" />
                                    </div>
                                </div>
...
@section('title')
    Atnumis &middot Add new selling coin.
@stop