            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_planel">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Orders description. <small></small></h2>
                                <div class="nav navbar-right panel_toolbox" style="font-size: 20px;">
                                    <div class="dropdown no-arrow">
                                        <a class="dropdown-toggle" href="#" style="padding: 5px; border: 2px solid grey;" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="product-detail-wrap">
                                            ...
                                            <div class="col-md-12 col-md-offset- " style="margin-bottom: 50px;">
                                                <div class="bg-whitesmoke" style="background: whitesmoke; margin-top: 40px; padding: 50px;">
                                                    <h2 style="margin-bottom: 30px;"> Coins ( {{ $order_info->no_of_coins }} ) </h2>
                                                    <table id="cart" class="table table-hover table-condensed">
                                                        <thead>
                                                            <tr>
                                                                <th style="width:60%">Coins</th>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @endif
                <div> From: <h4> {{ ucfirst( str_replace('-', ' ', $order_info->status) ) }} </h4>
                </div>
                <div class="mb-2">
                    <form method="post" action="/change-auction-order-status">
                        {{ csrf_field() }}
                        <label>To</label>
