            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div>
                                ...
                                <span class="dash-no"> {{ $data['new_orders'] }} Orders </span>
                            </div>
                        </div>
               ...
               <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="x_planel">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Previous Orders <small>  </small></h2>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <div>
                                <i class="fa fa-hands-helping"></i>
                                <span class="dash-no"> {{ $data['all_orders'] - $data['new_orders'] }} Orders </span>
                            </div>
                        </div>
                ...
                <div class="x_planel">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <div>
                                <i class="fa fa-hands-helping "></i>
                                <span class="dash-no"> {{ $data['all_orders'] }} Orders </span>
                            </div>
                        </div>
